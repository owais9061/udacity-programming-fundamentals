...
#Create the below variable to follo along the code

#print ("Example 1: Finding substrings in a string");
#print ('test'.find("te"));
#print ('test'.find("st"));
#print ('test'[2:]); #single quoted text is a string
...
#my_string ="My favorite subject is: Physics";
#subject_start_location = my_string.find("subject");
#favorite_subject = my_string[subject_start_location:];
#print (favorite_subject);
#print (favorite_subject[12:]);
